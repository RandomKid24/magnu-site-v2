...
export default function Fleet() {
  return (
    <section className="py-40 px-[5%] bg-black relative overflow-hidden scroll-mt-[100px]" id="fleet">
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="flex flex-col lg:flex-row justify-between items-end gap-12 mb-24">
            <div className="max-w-2xl">
              ...
              >
                ...
                <span className="font-sans text-[10px] font-bold tracking-[6px] uppercase text-gray-500">Infrastructure</span>
              </motion.div>
              ...
              <motion.h2 
                ...
                viewport={{ once: true }}
                className="font-space text-[clamp(40px,5vw,72px)] leading-[1] text-white tracking-tighter font-bold uppercase"
              >
                OUR PRECISION <br />
                <span className="text-lime">MACHINE FLEET.</span>
              </motion.h2>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-px bg-white/5 border border-white/5 shadow-2xl relative">
            {machinery.map((machine, i) => (
              <motion.div 
                ...
                className="bg-black p-12 flex flex-col group hover:bg-white transition-colors duration-700 relative overflow-hidden"
              >
                ...
                <h3 className="font-space text-2xl font-bold text-white group-hover:text-black transition-colors uppercase tracking-tight mb-8 mt-4">{machine}</h3>
              </motion.div>
            ))}
          </div>

          <div className="mt-32 border border-white/5 bg-white/5 overflow-hidden shadow-2xl relative">
            <div className="overflow-x-auto">
              <table className="w-full text-left">
                <thead>
                  <tr className="border-b border-white/5 bg-black/80 text-[10px] font-bold tracking-[3px] uppercase text-gray-500">
